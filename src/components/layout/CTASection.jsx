...
export default function CTASection({
    ...
    const inner = (
        <div className={`${v.bg} px-8 sm:px-16 py-16 sm:py-24 text-center ${v.wrapper}`}>
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    {primaryCTA && (
                        <Button variant={v.primary} size="lg" onClick={primaryCTA.onClick}>
                            {primaryCTA.label}
                        </Button>
                    )}
                    {secondaryCTA && (
                        <Button variant={v.secondary} size="lg" onClick={secondaryCTA.onClick}>
                            {secondaryCTA.label}
                        </Button>
                    )}
                </div>
